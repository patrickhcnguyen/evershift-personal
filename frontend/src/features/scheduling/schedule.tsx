...
export default function Schedule() {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const invoicesResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/invoices/branch/${userBranchId}`, {
        method: 'GET',
        headers: {
      ...
      for (const invoice of paidInvoices) {
        try {
          ...
          const requestResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/requests/${invoice.request_id}`, {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
            },
