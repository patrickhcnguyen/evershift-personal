    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const deleteStaffPromises = deletedStaffUuids.map(async (uuid) => {
                ...
                const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/staff-requirements/${uuid}`, {
                    method: 'DELETE',
                });
            ...
            const deleteCustomLineItemPromises = deletedCustomLineItemUuids.map(async (uuid) => {
                ...
                const response = await fetch(`/api/custom-line-items/${uuid}`, {
                    method: 'DELETE',
                });
            ...
            const staffPromises = editedStaff.map((staff, index) => {
                const baseUrl = `${import.meta.env.VITE_SERVER_URL}/api/staff-requirements`;
            ...
            const requestResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/requests/${editedInvoice.request_id}`, {
                method: 'PUT',
            ...
            const invoiceResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/invoices/${editedInvoice.uuid}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
            ...
            try {
                const ratesResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/rates/${editedInvoice.request_id}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                ...
                const finalInvoiceResponse = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/invoices/${editedInvoice.uuid}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
