resource "aws_cognito_user_pool" "pool" {
    name                = "evershift-user-pool-staging"
...
resource "aws_cognito_user_pool_client" "client" {
    name = "evershift-app-client-staging"
    ...
    callback_urls = ["http://localhost:8080/callback", "https://staging-your-app-domain.com/callback"]
    logout_urls   = ["http://localhost:8080/logout", "https://staging-your-app-domain.com/logout"]
